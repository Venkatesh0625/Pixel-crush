...
#include<stdlib.h>
using namespace std;
int** load_bmp(int& height,int& width)
{
	FILE *file,*f;
	char ch[200];
    char filename[]="C:/lenagray.bmp";
	...
	else
	{
		...
		//printf("\nReading the BMP File into Image Array Completed...\n\n");
	fclose(image_file);
	f = fopen("C:/lenagray.bmp","rb");
	file = fopen("C:/Users/Faker/Documents/Image_Header.txt","wb");
